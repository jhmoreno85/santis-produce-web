...
var MissionAndVisionComponent = (function () {
    function MissionAndVisionComponent(translate) {
    }
    MissionAndVisionComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return MissionAndVisionComponent;
}());
exports.MissionAndVisionComponent = MissionAndVisionComponent;
//# sourceMappingURL=mission-and-vision.component.js.map